...
describe("SettingsPageView", () => {
  ...
  it("Token 用量按原型包含渠道汇总和详情子页结构", () => {
    ...
    expect(source).toContain("function UsageMeter");
    ...
    expect(source).toContain('t("settings.token.platformQuota")');
    expect(source).toContain('t("settings.token.apiKeyConsumption")');
